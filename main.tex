...
\item \textcolor{blue}{Image classification} (Spectral Clustering of images based on Wordnet similarity and Image attribute): 

\item \textcolor{blue}{Unnamed}: A chrome plugin to manage all your passwords.
\end{itemize}
